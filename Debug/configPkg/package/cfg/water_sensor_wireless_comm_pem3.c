 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /media/DATA/Docs/programas/water_sensor/water_sensor_wireless_comm/Debug/configPkg/package/cfg/water_sensor_wireless_comm_pem3");
