...
.dlls,em3 .dlls: water_sensor_wireless_comm.pem3

-include package/cfg/water_sensor_wireless_comm_pem3.mak
-include package/cfg/water_sensor_wireless_comm_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/water_sensor_wireless_comm_pem3.dep
endif
water_sensor_wireless_comm.pem3: package/cfg/water_sensor_wireless_comm_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
water_sensor_wireless_comm.pem3 package/cfg/water_sensor_wireless_comm_pem3.c: .libraries,em3
endif

package/cfg/water_sensor_wireless_comm_pem3.c package/cfg/water_sensor_wireless_comm_pem3.h package/cfg/water_sensor_wireless_comm_pem3.xdl: override _PROG_NAME := water_sensor_wireless_comm.xem3
package/cfg/water_sensor_wireless_comm_pem3.c: package/cfg/water_sensor_wireless_comm_pem3.cfg
package/cfg/water_sensor_wireless_comm_pem3.xdc.inc: package/cfg/water_sensor_wireless_comm_pem3.xdl
package/cfg/water_sensor_wireless_comm_pem3.xdl package/cfg/water_sensor_wireless_comm_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/water_sensor_wireless_comm_pem3.cfg
	-$(RM) package/cfg/water_sensor_wireless_comm_pem3.dep
	-$(RM) package/cfg/water_sensor_wireless_comm_pem3.c
	-$(RM) package/cfg/water_sensor_wireless_comm_pem3.xdc.inc

clean,em3::
	-$(RM) water_sensor_wireless_comm.pem3
.executables,em3 .executables: water_sensor_wireless_comm.xem3

water_sensor_wireless_comm.xem3: |water_sensor_wireless_comm.pem3

-include package/cfg/water_sensor_wireless_comm.xem3.mak
water_sensor_wireless_comm.xem3: package/cfg/water_sensor_wireless_comm_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@) -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/water_sensor_wireless_comm_pem3.oem3   package/cfg/water_sensor_wireless_comm_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
water_sensor_wireless_comm.xem3: export C_DIR=
water_sensor_wireless_comm.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

water_sensor_wireless_comm.test test,em3 test: water_sensor_wireless_comm.xem3.test

water_sensor_wireless_comm.xem3.test:: water_sensor_wireless_comm.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 water_sensor_wireless_comm.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.water_sensor_wireless_comm.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,water_sensor_wireless_comm.xem3,*)


clean:: clean,em3

clean,em3::
	-$(RM) water_sensor_wireless_comm.xem3
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
water_sensor_wireless_comm_pem3.oem3,copy : package/cfg/water_sensor_wireless_comm_pem3.oem3
water_sensor_wireless_comm_pem3.sem3,copy : package/cfg/water_sensor_wireless_comm_pem3.sem3
